...
layout : tutorials
category : tutorials
title : Hyperledger Fabric - docker-compose로 배포
subcategory : setlayout
summary : Hyperledger Fabric를 docker-compose로 배포해 봅시다
permalink : /tutorials/hyperledger-fabric/deploy
author : marcushong
...
### 배포
앞에서 생성한 인증정보를 기반으로 docker-compose.yaml을 생성해 docker-compose를 생성하면 네트워크가 배포된다. 
